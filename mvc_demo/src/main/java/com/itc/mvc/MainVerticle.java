...
import com.itc.mvc.dao.UserDaoVerticle;
...
public class MainVerticle extends AbstractVerticle {
    ...
    public void start(Promise<Void> startPromise) {
        ...
        getJsonConf(confRet).onSuccess(jsonConf -> {
            ...
            // TODO 发布UserDaoVerticle 代表数据服务的Verticle 使用工作者模式进行发布
            vertx.deployVerticle(UserDaoVerticle.class.getName(), new DeploymentOptions().setWorker(true));
